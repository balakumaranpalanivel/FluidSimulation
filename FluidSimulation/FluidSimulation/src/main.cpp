...
GLuint CompileShaders()
{
    ...
    AddShader(shaderProgramID, "../FluidSimulation/src/shaders/simpleVertexShader.txt", GL_VERTEX_SHADER);
    AddShader(shaderProgramID, "../FluidSimulation/src/shaders/simpleFragmentShader.txt", GL_FRAGMENT_SHADER);
